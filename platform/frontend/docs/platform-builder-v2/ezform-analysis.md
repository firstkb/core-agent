...
This document captures what Platform Builder V2 should take from `ezform`, what it should improve, and what it should explicitly reject.
...
The goal is to reuse the strongest ideas from `ezform` while building a better V2 authoring experience that fits the approved Platform Builder direction.
...
- `platform/frontend/docs/platform-builder-v2/ezform/src/components/Builder.tsx`
- `platform/frontend/docs/platform-builder-v2/ezform/src/components/MainComponent.tsx`
...
- `platform/frontend/docs/platform-builder-v2/ezform/src/components/FieldList/FieldList.tsx`
...
- `platform/frontend/docs/platform-builder-v2/ezform/src/components/FormBuilder/FormCanvas.tsx`
- `platform/frontend/docs/platform-builder-v2/ezform/src/components/FormBuilder/FormField.tsx`
...
- `platform/frontend/docs/platform-builder-v2/ezform/src/components/SettingsPanel/SettingsPanel.tsx`
- `platform/frontend/docs/platform-builder-v2/ezform/src/components/SettingsPanel/FieldSettingsTab.tsx`
- `platform/frontend/docs/platform-builder-v2/ezform/src/components/SettingsPanel/FormSettingsTab.tsx`
- `platform/frontend/docs/platform-builder-v2/ezform/src/components/SettingsPanel/GridSettingsTab.tsx`
...
- `platform/frontend/docs/platform-builder-v2/ezform/src/utils/constants.ts`
...
- `platform/frontend/docs/platform-builder-v2/ezform/src/context/FormContext.tsx`
- `platform/frontend/docs/platform-builder-v2/ezform/src/utils/schemaGenerator.ts`
...
Platform Builder V2 should treat `ezform` as the main interaction reference for the future Form Builder.
...
Platform Builder V2 must support:
