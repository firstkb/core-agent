# Auth KMS Signing Proposal

Status: future proposal
Date: 2026-03-30
Last audited: 2026-04-25
Canonical scope: future AWS KMS-backed JWT signing for `cmd/auth`

This is not active runtime behavior.
Do not set `*_AUTH_KEYSOURCE=kms` in active runtimes until this proposal is implemented and verified.
