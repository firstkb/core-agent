...
<%
    ...
    Response.Redirect "OSHA300A.aspx?systemid="&SESSION("SYSTEM.ID")&"&company_id="&SESSION("CONFIG_COMPANYID")&"&userid="&SESSION("USER.ID")&_
        "&templateFileName=OSHA300A.pdf"&_
