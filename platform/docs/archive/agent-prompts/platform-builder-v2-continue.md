...
- platform/frontend/docs/platform-studio/old-code-reference/** смотреть только при реальной необходимости
- platform/frontend/docs/platform-studio/EXTDB/** использовать как legacy product-behavior reference:
  - field semantics
  - filters
  - pages
  ...
  - lookup behavior
  Код не копировать
- platform/frontend/docs/platform-studio/ezform/** это главный interaction reference для Form Builder:
  - three-zone shell
  - contextual palette
...
- use platform/frontend/docs/platform-studio/form-builder-field-catalog.md as the current final field catalog
