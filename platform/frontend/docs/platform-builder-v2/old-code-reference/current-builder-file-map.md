...
- `platform/frontend/docs/platform-builder-v2/old-code-reference/code-snapshot/tenant-web/src/features/platform-builder/draft/builder-draft-seed.ts`
...
- `platform/frontend/docs/platform-builder-v2/old-code-reference/code-snapshot/tenant-web/src/features/platform-builder/preview/resolve-builder-preview-state.ts`
...
| Shared typed contracts and validation | `platform/frontend/packages/platform-builder-core/**` | keep active foundation | remains live for contracts, schemas, manifest validation, route resolution, and visibility evaluation |
