...
export const formBuilderElementDefinitions: ReadonlyArray<FormBuilderElementDefinition> = [
  {
    category: "layout",
    descriptionKey: "tenant.platformBuilder.forms.builder.palette.sectionDescription",
    iconKey: "section",
  ...
  {
    category: "layout",
    descriptionKey: "tenant.platformBuilder.forms.builder.palette.groupDescription",
    iconKey: "group",
  ...
  {
    category: "containers",
    descriptionKey: "tenant.platformBuilder.forms.builder.palette.tabsDescription",
    iconKey: "tabs",
  ...
  {
    category: "containers",
    descriptionKey: "tenant.platformBuilder.forms.builder.palette.tabItemDescription",
    iconKey: "tab_item",
  ...
  {
    category: "content",
    descriptionKey: "tenant.platformBuilder.forms.builder.palette.textDescription",
    iconKey: "text",
...
export function getFormsWorkspaceAccess(
  ...
  return {
    ...
    lockReasonKey: isLocked
      ? "tenant.platformBuilder.forms.builder.lockedStructureNotice"
      : access.canEditViews
        ? null
        : (access.viewRestrictionKey ?? "tenant.platformBuilder.forms.permission.readonly"),
  };
}
...
export function getFormBuilderNodeSummary(
  ...
  if (node.type === "field") {
    ...
    return field?.isLocked
      ? "tenant.platformBuilder.forms.builder.summary.fieldLocked"
  ...
  if (children.length > 0) {
    return "tenant.platformBuilder.forms.builder.summary.children";
  }

  return "tenant.platformBuilder.forms.builder.summary.emptyContainer";
}
