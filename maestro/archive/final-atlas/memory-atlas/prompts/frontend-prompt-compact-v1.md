...
- if a run exists, return a compact lane report in `maestro/memory/runs/active/<task-id>/frontend.md`
...
- for non-trivial visible UI work, use or create a compact UI Task Packet from `maestro/memory/atlas/templates/ui-task-packet.md`; tiny copy/CSS fixes may skip it
