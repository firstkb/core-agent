# Retired Prompt - Backend Compact Lane v1

Status: retired legacy prompt pointer
Retired on: 2026-04-25

This file is no longer the active compact backend lane prompt.
...
Do not launch backend agents from this legacy prompt.
