...
Canonical scope: local backend database, migration, seed, key, and runtime bootstrap
...
- full key-source setup examples live in `platform/backend/docs/runbooks/auth-key-sources.md`
