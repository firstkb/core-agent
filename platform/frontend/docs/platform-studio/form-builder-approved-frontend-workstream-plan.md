...
Canonical scope: historical Form Builder frontend workstream plan

This document is retired from the active Form Builder read path.
Do not use it as current product truth or implementation scope.
...
- The durable field, view, palette, and runtime decisions have been compacted into active docs.
- This workstream plan mixed sequencing history with product facts.
