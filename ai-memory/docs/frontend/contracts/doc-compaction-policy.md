...
1. Current code.
2. Root repo guidance and `ai-memory`.
3. Current tracked contracts.
4. Working plans.
5. Donor/reference docs.
6. Prompt artifacts and archives.

If a tracked doc says a feature is not extracted but code and `ai-memory` say it is extracted, code and compact memory win.
