...
Canonical scope: JWT signing and validation key source configuration for backend runtimes

Read with:

- `platform/backend/docs/contracts/auth-gateway.md`
- `platform/backend/docs/modules/auth.md`
- `platform/backend/docs/proposals/kms-signing.md` for future KMS signer work
