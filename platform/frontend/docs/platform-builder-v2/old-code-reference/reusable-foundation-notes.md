...
- `platform/frontend/packages/platform-builder-core/src/runtime/published-manifest-runtime-error.ts`
...
- it is no longer presented as Platform Builder authoring UI
