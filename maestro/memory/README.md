...
6. `maestro/memory/index/memory-index.yaml` when broader routing is needed
7. `maestro/memory/durable/module-index.md` when module ownership is unclear
8. `maestro/memory/agent-workflow.md` when workflow/update rules matter
...
- collection table
- Platform Studio suite, Form Builder, and Navigation Builder UI-first V1
