...
This folder stores reference material for the retired Platform Builder implementation without letting that implementation act like live product guidance again.
