...
Canonical scope: event actor identity fields for master and tenant events

Read with:

- `platform/backend/docs/contracts/schema-tenancy.md`
- `platform/backend/docs/proposals/events-mails-cleanup.md` when events/mail cleanup is activated
