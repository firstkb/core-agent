...
export function createRuntimeFormFixtureDefinition({
  ...
  return {
    ...
    sections: [
      ...
      {
        description: "Ready-made presets reuse base runtime controls with preset-specific input behavior.",
        nodes: [
          {
            id: "contact_email",
            label: "Email",
...
export function createRuntimeFormFixture(input: RuntimeFormFixtureInput): RuntimeFormFixture {
  ...
  return {
    ...
    values: {
      ...
      calculated_score: "82",
      checkbox_group: ["supervisor", "safety"],
      city_suggest: "Austin",
      comment: "Clear and organize wood and debris to maintain neat storage.",
      contact_email: "andrii@example.com",
      contact_phone: "(555) 123-4567",
      crew_size: "3",
      date_today: "2026-02-20",
