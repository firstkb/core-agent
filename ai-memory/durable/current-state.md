...
- `risk` `doc-confirmed`: Historical `platform/docs/ai/modules/**`, prompts/templates payloads, and run payloads still exist in the repository. Use `ai-memory/durable/legacy-memory-import.md` only when historical reconstruction is explicitly needed.
