...
- `landed` `doc-confirmed`: Form Builder exact-detail consolidation audit lives at `ai-memory/docs/frontend/platform-studio/form-builder-exact-detail-consolidation-audit.md`; it keeps 14 docs as exact-detail, marks 4 for future extraction before deletion, and records 5 low-risk docs deleted after extraction into `form-builder-fields.md`.
...
- `risk` `doc-confirmed`: Do not delete retained exact-detail docs without following the consolidation audit extraction targets; the first low-risk deletion wave extracted advanced, content nodes, field rules, grid columns, and checklist subform details into `form-builder-fields.md`.
