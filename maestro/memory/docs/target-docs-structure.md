...
- Keep local `maestro/memory` as the retrieval layer, not as the tracked product docs replacement.
...
5. Update `maestro/memory/docs/*/doc-map.md` and `maestro/memory/durable/canonical-docs.md`.
