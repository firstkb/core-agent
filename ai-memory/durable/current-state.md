...
- `landed` `doc-confirmed`: Form Builder exact-detail consolidation audit lives at `ai-memory/docs/frontend/platform-studio/form-builder-exact-detail-consolidation-audit.md`; it keeps 14 docs as exact-detail and marks 9 for future extraction before deletion.
...
- `risk` `doc-confirmed`: Do not delete exact-detail docs without following the consolidation audit extraction targets; no payload-bearing exact-detail doc was deleted in the audit pass.
