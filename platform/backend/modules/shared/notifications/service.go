...
import (
	...
	"dtriton.com/platform/backend/internal/platform/notify"
...
type Service interface {
	...
	SendRenderedEmail(ctx context.Context, input notify.EmailInput) (notify.MessageID, error)
	SendRenderedSMS(ctx context.Context, input notify.SMSInput) (notify.MessageID, error)
}
...
func (s *NotifyService) SendRenderedEmail(ctx context.Context, input notify.EmailInput) (notify.MessageID, error) {
	return s.notify.SendEmail(ctx, input)
}

func (s *NotifyService) SendRenderedSMS(ctx context.Context, input notify.SMSInput) (notify.MessageID, error) {
	return s.notify.SendSMS(ctx, input)
}
