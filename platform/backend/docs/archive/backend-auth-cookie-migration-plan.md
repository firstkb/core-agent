...
Historical status: active working plan
Date: 2026-03-30
Last audited: 2026-04-25
Canonical scope: historical auth cookie migration plan

This is archived history.
Current auth behavior is defined by the active auth contracts and code.
