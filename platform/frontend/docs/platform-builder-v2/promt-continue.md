...
- /Volumes/HD/Projects/github/firstkb/core-agent/platform/frontend/docs/platform-builder-v2/old-code-reference/** смотреть только при реальной необходимости
- /Volumes/HD/Projects/github/firstkb/core-agent/platform/frontend/docs/platform-builder-v2/EXTDB/** использовать как legacy product-behavior reference:
  - field semantics
  - filters
  - pages
  ...
  - lookup behavior
  Код не копировать
- /Volumes/HD/Projects/github/firstkb/core-agent/platform/frontend/docs/platform-builder-v2/ezform/** это главный interaction reference для Form Builder:
  - three-zone shell
  - contextual palette
...
- Platform Builder V2 has two main builders:
  - UI Builder
  - Navigation
...
- keep implementation app-local in tenant-web under platform-builder-v2
- do not create a new shared package unless reuse is clearly proven
- keep platform-builder-core and published-app as technical substrate/reference only
...
- dark theme was already locally tuned in platform-builder-v2.css
- Save is explicit
...
- use /Volumes/HD/Projects/github/firstkb/core-agent/platform/frontend/docs/platform-builder-v2/form-builder-field-catalog.md as the current final field catalog
...
- then continue helping me develop Platform Builder frontend without losing the decisions above
