...
- `control-chat-prompt-v1.md`
  ...
  - current semantic version: see `platform/docs/ai/automation-manifest.json`
...
- semantic patch/minor versions are edited in `platform/docs/ai/automation-manifest.json` and mirrored into file frontmatter
- record prompt versions in `platform/docs/ai/runs/<task-id>/task.md` when a run exists
