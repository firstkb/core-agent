...
- Distill reusable decisions into `maestro/memory` module contracts, state, or lessons.
...
- compact design lessons in `maestro/memory/modules/frontend/ui-kit/README.md`
- package boundary notes in `maestro/memory/modules/frontend/workspace/`
