...
This policy applies to `platform/frontend/docs/platform-studio/**` and the compact local maps under `ai-memory/docs/frontend/platform-studio/`.
...
- After a feature slice lands, compact durable facts into `ai-memory/modules/domains/platform-studio/state.md` or `contract.md`.
- Put reusable mistakes and guardrails into `ai-memory/modules/domains/platform-studio/lessons.md`.
...
3. `ai-memory` compact module contracts/state.
