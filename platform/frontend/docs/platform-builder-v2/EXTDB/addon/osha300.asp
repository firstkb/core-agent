...
<%
    ...
    If varAction="list" Then
        Dim varSql : varSql = "SELECT " & _
            ...
            " WHERE [OSHA Reportable]='Yes' AND DatePart(yyyy,[Date of Injury])="&Request("yearSelect")&" AND ISNULL(loc.[State],'') NOT LIKE 'CA' " & _
    ...
    Else
        ...
        GUI.GenerateForm "..\addon\lib_OSHA300Report.htm", "irinjury", ""
        GUI.PageTitle = "OSHA300 Report"
        GUI.Draw
    End If
