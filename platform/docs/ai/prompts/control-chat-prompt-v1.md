...
Use `platform/docs/ai/automation-manifest.json` as the authoritative editable version source. Atlas should consult manifest values when version data is needed and should not invent them.
