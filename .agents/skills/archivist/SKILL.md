...
`archivist` is the semantic docs and ai-memory audit workflow.
...
Archivist complements the mechanical gate:
...
Use `archivist` when the owner asks to:
...
Do not use Archivist for normal implementation, code research, or feature orchestration.
...
By default, Archivist audits and recommends.
...
- Do not turn Archivist into a feature implementation agent.
