...
- tiny direct implementation only when route tier is `direct`.
...
- feature decomposition depends on repository structure.
...
- implementation attempt `README.md`;
- `handoff.json`;
...
- verification attempt `README.md`;
- `handoff.json`;
...
- review attempt `README.md`;
- review handoff or findings.
...
- semantic docs and `ai-memory` auditor.

Use when:

- durable docs or `ai-memory` may need update;
