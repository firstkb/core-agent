...
- `control-chat-prompt-v1.md`
  ...
  - current semantic version: see `maestro/memory/atlas/automation-manifest.json`
  - owner: `vsm-v1.0.0`
...
- semantic patch/minor versions are edited in `maestro/memory/atlas/automation-manifest.json` and mirrored into file frontmatter
- record prompt versions in `maestro/memory/runs/active/<task-id>/task.md` when a run exists
