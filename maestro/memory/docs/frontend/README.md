...
Use this folder for compacted frontend docs.
Do not mirror the entire `platform/frontend/docs` corpus here.

## Target Rewrite

- `maestro/memory/docs/target-docs-structure.md`

## Active Compact Frontend Packs

- `maestro/memory/modules/frontend/workspace/`
- `maestro/memory/modules/frontend/auth-runtime/`
- `maestro/memory/modules/frontend/platform-admin-web/`
- `maestro/memory/modules/frontend/tenant-web/`
- `maestro/memory/modules/frontend/collection-table-package/`
- `maestro/memory/modules/frontend/platform-studio-ui/`
- `maestro/memory/modules/frontend/ui-kit/`

## Compact Frontend Doc Maps
...
Use tracked source docs for deep detail:
...
For Platform Studio, read the compact local map before opening the tracked source folder:
...
Do not pull old prompts, donor references, or closed workstream plans into active memory.
Summarize reusable lessons into module `lessons.md` and leave the raw source in archive/reference paths.
